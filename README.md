*hey*, i'm **Mohannad**, fullstack engineer. mass produces web apps. mass consumed by AI.

i've been building things across fintech, logistics, SaaS, and telecom for a while now - high-traffic apps, multi-tenant platforms, chrome extensions, desktop apps, you name it. i care a lot about performance, type safety, and shipping things that actually work well.
...
when i'm not shipping features or arguing with an LLM, i'm probably brewing pour-over coffee, tinkering with Unity3D, or convincing my finetuned LLM model that it's smarter than it thinks.

> most of what i build doesn't live here - this is just the tip of the iceberg.
